...
@ChannelHandler.Sharable public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket>
{
    ...
    @Override protected void encode (ChannelHandlerContext ctx, AbstractPacket msg, List<Object> out) throws Exception
    {
    ...
    {
        this.channels = NetworkRegistry.INSTANCE.newChannel("fuj1n.RecMod", this);
    }
    ...
    public void postInitialise ()
    {
        ...
        Collections.sort(this.packets, new Comparator<Class<? extends AbstractPacket>>()
        {
            ...
            @Override public int compare (Class<? extends AbstractPacket> clazz1, Class<? extends AbstractPacket> clazz2)
            {
